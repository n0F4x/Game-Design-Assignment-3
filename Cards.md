...
Pick an enemy tile next to one of your tokens.
If it has 1 token, replace it with one of your own.
If it has more than 1 token, remove 2 of those.
You cannot place more tokens this turn.
...
This turn, when you draw cards, draw 3 and keep all 3.
...
Gain an additional token from the hidden reserve.
